...
# imports from cheadice.py ( this is the local directory)
...
def main():
    ...
    cheater1 = Cheat_Swapper() # abilirt is to change 3rd dice roll to 6
    cheater2 = Cheat_Loaded_Dice() # increase all rolls by +1 provided they are < 6

    # both palyers take turns
    cheater1.roll()
    cheater2.roll()

    # both players use theior cheat methods
    cheater1.cheat()
    cheater2.cheat()
